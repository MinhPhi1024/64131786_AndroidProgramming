...
import ntu.leminhphi.example.mathquizapp.Models.DoiTuongModels;
import ntu.leminhphi.example.mathquizapp.databinding.ActivityAdminThemBinding;

public class Admin_ThemActivity extends AppCompatActivity {
        ...
        binding.btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(tenlop.isEmpty()) {
                    ...
                    Toast.makeText(Admin_ThemActivity.this, "Hãy chọn ảnh", Toast.LENGTH_SHORT).show();
                        ...
                        datebase.getReference().child("tenlop").push()
                                .setValue(doiTuongModels).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(Admin_ThemActivity.this, "Thêm thành công", Toast.LENGTH_SHORT).show();
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        loadingdialog.dismiss();
                                        Toast.makeText(Admin_ThemActivity.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                });
